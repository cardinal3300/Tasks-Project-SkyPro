...
def card_number_generator(start: int, stop: int) -> Iterator[str]:
    ...
    # Дополнение нулями слева до 16 символов
        if len(card_number_str) < 16:
            ...
            formatted_card_number = f"{card_number_str[0:4]} {card_number_str[4:8]} {card_number_str[8:12]} {card_number_str[12:]}"
...
def format_card_number(number: int) -> str:
    ...
    if len(card_number_str) < 16:
        card_number_str = '0' * (16 - len(card_number_str)) + card_number_str
    formatted_card_number = f"{card_number_str[:4]} {card_number_str[4:8]} {card_number_str[8:12]} {card_number_str[12:]}"
