...
def test_filter_by_state_str(test_data: Any) -> None:
    ...
    with pytest.raises(TypeError) as exc_info:
        sort_by_date(
            [
                {"id": 939719570, "state": 123456, "data": "2018-06-30T02:08:58.425572"},
                {"id": 594226727, "state": 123456, "data": "2018-09-12T21:27:25.241689"},
            ]
        )
...
def test_sort_by_date_raise(test_data: Any) -> None:
    with pytest.raises(TypeError) as exc_info:
        sort_by_date(
            [
        ...
        # Проверяет, что сообщение об ошибке соответствует ожидаемому
        assert exc_info.value == "У всех словарей должен быть ключ 'date'."
